  ...
  return (
    <section className='main-container'>
            ...
            <div className="row">
              <div className="col-lg-7 col-md-12 col-12">
                ...
                <div className="banner-button-group  my-3 d-flex align-items-center flex-wrap">
                  <a href="/markets" className="button-4 btn-warning mb-3 me-3">BUY DFC </a>
                  <a target="" href="/static/assets/whitePaperNew.pdf" className="button-4 active mb-3 me-3">Read White Paper</a>
                  <a href="https://t.me/deficonnect" target="_blank" rel="noopener noreferrer" className="button-4 active mb-3">Join Our Community
                  </a>
                </div>
              </div>
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="mt-3 mb-5 contract-border">
                ...
                <input type="email" className="form-control" id="wallet-email" placeholder="name@example.com" value="0x996c1bf72Ec220289ae0edd3a8d77080642121a2" readOnly />
      ...
      <section className="about-section pt-5">
        ...
        <div className="my-5 about-content">
          <div className="container mb-5">
            ...
            <p> DefiConnect is likened to an ecosystem with huge potentials and opportunities that will bring about a
              major positive
            ...
            <p className='pb-4'> We have also molded the generic block chain technology for specific use cases with a lightweight and
              easy-to-customize
              implementation.</p>
            <div className="mt-4">
              <a href="/static/assets/whitePaperNew.pdf" target="" className="button-3 btn-warning mt-5">Read White Paper</a>
            </div>
            <div className="section-header cl-white mt-5">
                ...
                <div>
                  <div className="row">
                    <div className="col-md-8 mb-3">
                      ...
                      <p data-target="index.walletAddress">...</p>
                    </div>
      ...
      <section className="team-section">
        <div className="container">
          <div style={{ marginTop: 30 + 'px' }} className="">
            <div className="section-header cl-white">
            ...
            <div className="">
              <div className="row">
                <div className="col-md-4 team-member text-center mb-3">
      ...
      <section id="roadmap" className="faq-section padding-top">
        <div className="container">
          <div className="">
            ...
            <a href="/future" className="button-3 btn-warning">See vision Board</a>
          </div>
        </div>
