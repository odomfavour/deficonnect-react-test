...
const index = () => {
    return (
        <section className='main-container'>
                    ...
                    <div className="hero">
                        <div className="row">
                            <div className="col-lg-7 col-md-12 col-12">
                                ...
                                <p>DefiConnect is a revolutionized digital community with state-of-the-art, real-world cryptocurrency powered solutions in digital marketing, healthcare, transportation, logistics, and multilevel marketing.</p>
                                <div className="banner-button-group my-3 d-flex align-items-center justify-content-between flex-md-row flex-column">
                                    <a href="/markets" className="button-4 btn-warning mb-3">BUY DFC </a>
                                    <a target="" href="/static/assets/whitePaperNew.pdf" className="button-4 active mb-3">Read White Paper</a>
                                    <a href="https://t.me/deficonnect" target="_blank" rel="noopener noreferrer" className="button-4 active mb-2">Join Our Community
                                    </a>
                                </div>
                            </div>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <p>
                                Unlike every other system, being a part of our DefiConnect gives you real time access into how the chains binding our demand and supply system really works.
                        ...
                        <div className="col-md-6">
                            ...
                            <ul>
                                <li><span>Token Name:</span> DefiConnect</li>
                                <li><span>Symbol:</span> DFC</li>
                                <li><span>Total Suply:</span> 200,000,000,000,000 DFC</li>
                                <li><span>Decimal:</span> 8</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="my-5 about-content">
                    <div className="container mb-5">
                        ...
                        <div className="section-body">
                            <p className="fadeInDown" data-wow-duration="0.4s" data-wow-delay="0.4s">
                                DefiConnect is likened to an ecosystem with huge potentials and opportunities that will bring about a
                                major positive
                                shift in the financial economy. This will also encumber into the social sphere as well as impacting
                                political
                                transparency.
                            </p>
                            <p className="fadeInDown" data-wow-duration="0.4s" data-wow-delay="0.4s">
                                More than just trading on exchanges, our currency (DFC) serves as a passing link into incentives rarely
                                experienced in
                                other ecosystems .we have successfully executed and stretched the domains of crypto currency beyond just
                                financial
                                transactions.
                            </p>
                            <p className="fadeInDown mb-5" data-wow-duration="0.4s" data-wow-delay="0.4s">
                                We have also molded the generic block chain technology for specific use cases with a lightweight and
                                easy-to-customize
                                implementation.
                            </p>
                            <a href="/static/assets/whitePaperNew.pdf" target="" className="button-3 btn-warning">Read White Paper</a>
                        </div>
                            ...
                            <div className="col-md-12" id="countdown">
                                <div style={{ marginTop: 40 + 'px' }} className="row">
                                    <div className="col-md-8 mb-3">
                                        ...
                                        <p style={{ fontSize: 20 + 'px' }} data-target="index.walletAddress">...</p>
                                    </div>
                                ...
                                <div className="row mt-3">
                                    <div className="col-md-6 mb-5">
                                        ...
                                        <table className="deposit-table1 table fg-white mt-3" style={{ display: 'none', color: 'white' }}>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th colSpan={2} className="text-right">Farm Size</th>
                            ...
                            <div className="section-body row">
                                <div className="col-md-6 mb-3">
                                    <div className="why-wrapper">
                                        ...
                                        <p>The viability of our super real life applications has consistently ensured that a whooping
                                            first of its kind 190% rate
                                            of returns with a daily earning of <span data-target="index.dailyReward">1.24</span>% is a seamlessly harvested by all the token holders.
                                        </p>
                                    </div>
                                </div>
                                <div className=" col-md-6 mb-3">
                                    <div className="why-wrapper">
                                        <div className="section-header cl-white">
                                            <h2 style={{ marginTop: 15 + 'px' }}>Free transactions </h2>
                                            <i className="fas fa-credit-card"></i>
                                        </div>
                                        <p>With DefiConnect, you are in full control of the funds as we have eliminated third-party
                                            expenses by charging zero
                                            extra monthly subscription fees.</p>
                                    </div>
                                </div>
                                <div className=" col-md-6 mb-3">
                                    <div className="why-wrapper">
                                        ...
                                        <p>To further reinstate our level of commitment, The addresses and daily profit accumulation
                                            records of token holders will
                                            be on open display on our platforms at a single click.</p>
                                    </div>
                                </div>
                                <div className="col-md-6 mb-3">
                                    <div className="why-wrapper">
                                        <div className="section-header cl-white">
                                            <h2 style={{ marginTop: 15 + 'px' }}>Real-world application </h2>
                                            <i className="fas fa-rocket"></i>
                                        </div>
                                        <p>We are connecting Defi with every aspect that makes up the real-life departments.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div style={{ marginTop: 30 + 'px' }} className="mlm-launchpad">
                            <div className="section-header cl-white">
                                <h2 className="title"> Multi-Level Marketing (MLM) Launchpad&nbsp;</h2>
                                <h5 className="cate">(LIVE)</h5>
                            </div>
                            <div className="section-body">
                                <p>
                                    We have simply applied the immutable and permissible nature of Smart Contracts to circumvent the
                                    drawbacks that once
                                    characterized the MLM business to function with the highest security and zero risks. We offer care
                                    for a unique and new
                                    perspective to the MLM business laced with fast-paced and transparent transactions using our
                                    ecosystems token. People
                                    who also join the MLM scheme will receive benefits in the form of crypto assets and tokens through
                                    an automated process.
                                </p>
                                <p>
                                    This innovation will give institutions the ability to create a campaign and allow our users to serve
                                    as sales agents
                                    using the power of their network.
                                </p>
                                <a href="/launchpad" className="button-3 btn-danger">Launchpad</a>
                            </div>
                        </div>
                        <div style={{ marginTop: 30 + 'px' }} className="DEHIM">
                            ...
                            <div className="section-body">
                                <p>Our healthcare application can be envisaged in five core areas:&nbsp;</p>
                                ...
                                <p>
                                    The acquisition of our tokens as a digital asset automatically opens you up to using our health
                                    package. Once you come
                                    on board as a member, our mobile health app, and remote monitoring ensures the security of your
                                    electronic medical
                                    records on our network. Your data can be rapidly sent to trusted and certified medical personnel in
                                    case of an
                                    emergency. It is also available for self-monitoring and home care for personal use.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div style={{ marginTop: 30 + 'px' }} className="tokenomics">
                        <div className="section-header cl-white">
                            ...
                            <p>In an ever evolving space championed by the rapid advances in technology and increased access to
                                markets, the need to be
                                agile, flexible, and adaptable have become a necessity. Our team comprises of a collection of
                                versatile individuals with
                        ...
                        <div className="">
                            <div className="row">
                                <div className="col-md-4 team-member text-center">
                                    ...
                                    <a href="https://www.linkedin.com/in/ademuanthony/" target="_blank" rel="noopener noreferrer" className="social"><i className="fab fa-lg fa-linkedin "></i></a>
                                </div>
                                <div className="col-md-4 team-member text-center">
                                    <img className="img img-fluid" src={raph} alt="TeamMember" />
                                    <h3>Raphael Ikediashi </h3>
                                    <p className="team-rank">MD</p>
                                    <a href="https://www.linkedin.com/in/raphael-ikediashi-b9888249/" target="_blank" rel="noopener noreferrer" className="social"><i className="fab fa-lg fa-linkedin"></i></a>
                                </div>
                                <div className="col-md-4 team-member text-center">
                                    <img className="img img-fluid" src={albert} alt="TeamMember" />
                                    <h3>Albert Jaku</h3>
                                    <p className="team-rank">Team Member</p>
                                    <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="social"><i className="fab fa-lg fa-linkedin"></i></a>
                                </div>
            ...
            <section id="2" className="faq-section padding-top">
                <div className="container">
                    <div className="">
                        ...
                        <p style={{ margin: ` auto 10px` }}>
                            DefiConnect is all about building real world applications that bring the many benefits of the DeFi
                            ecosystem to our
                            everyday lives. Some plans here might evolve with time, but it will remain consistent with the long term
                            vision of
                            connecting DeFi to our lives by building real world applications that benefit our regular everyday
                            lives.
                        </p>
                            ...
                            <ol className="roadmap__events">
                                <li className="roadmap__events__event" style={{ left: `0%` }}>
                                    <div className="event">
                                        ...
                                        <div className="event__content">1. DFCTipper <br />
                                            2. Launchpad Upgrade<br />
                                            3. Exchanges Listing<br />
                                            4. DefiPay Public Launching<br />
                                            5. Liquidity Farming<br />
                                            6. Deficonnect Metaverse</div>
                                    </div>
                                </li>
                                <li className="roadmap__events__event" style={{ left: `33.33%` }}>
                                    <div className="event">
                                        <div className="event__date">Q2 - 2022</div>
                                        <div className="event__content">1. Metaverse Initial land offering (ILO)<br />
                                            2. Exchanges Listing<br />
                                            3. Defipay Multi wallet mobile App<br />
                                            4. NFTs marketplace<br />
                                            5. Top Token Hub
                                        </div>
                                    </div>
                                </li>
                                <li className="roadmap__events__event" style={{ left: `60%` }}>
                                    <div className="event"><div className="event__date">Q3 - 2022</div><div className="event__content">1. Decentralized health insurance marketplace<br />
                                        2. Exchanges Listing<br /></div></div></li>
                                <li className="roadmap__events__event" style={{ left: `100%` }}><div className="event"><div className="event__date">Q4 - 2022</div><div className="event__content">1. Decentralized health Information marketplace(Dehim)<br />
                                    2. Exchanges Listing<br /></div></div></li>
                            </ol>
                        ...
                        <p className="mt-5">
                            The future of DefiConnect is solely hinged on the success and growth of our community. With a large chunk of our
                            projects already in the pipeline, we intend to become the face of the crypto community in Africa and help our
                            members
                            grow their wealth and enjoy seamless services on our platforms.
                        </p>
                        <a href="/future" className="button-3 mt-3 btn-warning">See vision Board</a>
                    </div>
                </div>
                        ...
                        <div className="row py-md-5 py-3">
                            ...
                            <div className="col-lg-3 col-md-5 col-6 mb-3 px-2">
                                <div className="secured-box">
                                    <a href="https://leaderboard.certik.io/projects/defi-connect" target="_blank" rel="noopener noreferrer">
                            ...
                            <div className="row p-4">
                                <div className="col-lg-3 col-md-3 col-6 mb-3">
                                    <div className="image-box">
                                        <a href="https://latoken.com/exchange/DFC_USDT" target="_blank" rel="noopener noreferrer">
                                ...
                                <div className="col-lg-3 col-md-3 col-6 mb-3">
                                    <div className="image-box">
                                        <a href="https://www.hotbit.io/exchange?symbol=DFC_USDT" target="_blank" rel="noopener noreferrer">
                                            <img className="img-fluid mb-2 " src={hotbit} alt="roadmap" />
                                        </a>
                                    </div>
                                </div>
                                <div className="col-lg-3 col-md-3 col-6 mb-3">
                                    <div className="image-box">
                                        <a href="https://www.bitmart.com/trade/en?layout=pro&amp;symbol=DFC_USDT" target="_blank" rel="noopener noreferrer">
                                            <img className="img-fluid mb-2 ml-2 " src={bitmart} alt="roadmap" />
                                        </a>
                                    </div>
                                </div>
                                <div className="col-lg-3 col-md-3 col-6 mb-3">
                                    <div className="image-box">
                                        <a href="https://www.bitrue.com/trade/dfc_usdt" target="_blank" rel="noopener noreferrer">
                                ...
                                <div className="col-lg-3 col-md-3 col-6 mb-3">
                                    <div className="image-box">
                                        <a href="https://digitalcoinprice.com/blog/deficonnect-spikes-300-growth" target="_blank" rel="noopener noreferrer">
                                            <img className="img-fluid mb-2 ml-2 " src={coinsbit} alt="roadmap" />
                                        </a>
                                    </div>
                                </div>
                                <div className="col-lg-3 col-md-3 col-6 mb-3">
                                    <div className="image-box">
                                        <a href="https://www.coingecko.com/en/coins/deficonnect" target="_blank" rel="noopener noreferrer">
                                            <img className="img-fluid mb-2 ml-2 " src={coingecko} alt="roadmap" />
                                        </a>
                                    </div>
                                </div>
                                <div className="col-lg-3 col-md-3 col-6 mb-3">
                                    <div className="image-box">
                                        <a href="https://coinmarketcap.com/currencies/defi-connect/" target="_blank" rel="noopener noreferrer">
                                            <img className="img-fluid mb-2 ml-2 " src={coinmarketcap} alt="roadmap" />
                                        </a>
                                    </div>
                                </div>
                            </div>
